...
По дефолту авторизация **пройдена**, при возникновении желания посмотреть страницу авторизации - нажимаем **LOGOUT** вверху справа. Валидная пара логина и пароля: _login:"poke@poke.ru"_, _password: "Hdnc18pEf"_ (вводить без кавычек). При успешной авторизации в LocalStorage прописывается токен, для последующего допуска в приложение без повторного прохождения авторизации.
